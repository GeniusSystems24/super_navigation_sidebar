...
class ResponsiveShellExample extends StatefulWidget {
  ...
  @override
  State<ResponsiveShellExample> createState() => _ResponsiveShellExampleState();
}
...
class _ResponsiveShellExampleState extends State<ResponsiveShellExample> {
  bool _light = false;
                  ...
                  child: Row(
                    children: [
                      _SegCtrl(
                        ...
                        selected: _devices.indexWhere((d) => d.$1 == _device),
                        onChanged: (i) =>
                                    ...
                                    child: Row(
                                      children: [
                                        GestureDetector(
                                          ...
                                          child: Icon(Icons.menu, color: s.fg1),
                                        ),
                ...
                Expanded(
                  child: GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      alignment: Alignment.center,
                      decoration: BoxDecoration(
                        color: light == opt.$1 ? s.surface : Colors.transparent,
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    'Go to Help Center →',
                    style: TextStyle(fontSize: 11, color: s.fg3),
                  ),
                ],
              ),
            ],
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Opacity(
              opacity: 0.5,
              child: Container(height: 26, width: 240, decoration: muted),
            ),
                    ...
                    for (int i = 0; i < cols; i++)
                      Opacity(
                        ...
                        child: SizedBox(
                          width: w,
                          height: 100,
                          child: DecoratedBox(decoration: muted),
                        ),
                      ),
                  ],
                );
            ...
            Opacity(
              opacity: 0.5,
              child: Container(height: 260, decoration: muted),
            ),
          ],
        ),
      ),
